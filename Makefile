.PHONY: install format lint test run api demo eval benchmark docker-build
...
benchmark:
	PYTHONPATH=src python -m maie.evaluation.cli --benchmark examples/evals/benchmark_cases.json
